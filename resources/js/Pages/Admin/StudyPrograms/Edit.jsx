...
export default function StudyProgramEdit({ auth, program }) {
    const { data, setData, patch, processing, errors } = useForm({
        code: program.code || '',
        name: program.name || '',
        faculty: program.faculty || '',
        level: program.level || 'S1',
        class_type: program.class_type || 'Regular',
    ...
    const submit = (e) => {
        e.preventDefault();
        patch(route('admin.study-programs.update', program.id));
    };
